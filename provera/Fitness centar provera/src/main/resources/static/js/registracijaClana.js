$(document).on("submit","form",function(event){		 // kada je submit-ovana forma za kreiranje novog clana
	...
	var newClanDTORegJSON=formToJSON(korisnickoIme,lozinka,ime,prezime,kontakt_telefon,email,datum_rodjenja);
